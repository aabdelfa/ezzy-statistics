          ...
          <div class="row">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                          ...
                          foreach ($a as $v) {
                            $dir = "../../includes/files/videos/" . str_replace(' ', '_', $v) . "/";
           ...
           <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Upload video file(s)</h3>
                </div><!-- /.box-header -->      
                <form role="form" action="videos_upload.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">   
                    <div class="form-group">
                        <label for="fileToUpload">Video input</label>
                        <input type="file" name="files[]" id="fileToUpload" multiple>
                        <p class="help-block">Here you can upload Video files <b>only</b>.</p>
                    </div>
                    <div class="form-group">
