          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">All Presentations</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>PowerPoint name</th>
                        <th>Size</th>
                        <th>Type</th>
                        <th>Category</th>
                        <th>Action</th>
                    ...
                    <tbody>
                      <?php
                          $a = array("Classification","Control Charts","Correlation and Association",
                           ...
                           foreach ($a as $v) {
                            $dir = "../../includes/files/ppt/" . str_replace(' ', '_', $v) . "/";
           ...
           <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Upload Presentation file(s)</h3>
                </div><!-- /.box-header -->      
                <form role="form" action="ppt_upload.php" method="post" enctype="multipart/form-data">
                  <div class="box-body">   
                    <div class="form-group">
                        <label for="fileToUpload">PowerPoint input</label>
                        <input type="file" name="files[]" id="fileToUpload" multiple>
                        <p class="help-block">Here you can upload PowerPoint files <b>only</b>.</p>
                    </div>
                    <div class="form-group">
