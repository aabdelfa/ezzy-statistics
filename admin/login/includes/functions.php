<?php
	...
	function find_pages() { //query for user by id
		...
		function blogs() { //query for blogs
		global $connection;
		...
		function about_page() { //query for about
		global $connection;
		...
		function contact_info() { //query for about
		global $connection;
		...
		function education() { //query for education
    global $connection;
    $query  = "SELECT * ";
    ...
    confirm_query($education);
		...
		function work() { //query for work experience
    global $connection;
    $query  = "SELECT * ";
    $query .= "FROM work ";
    $query .= "ORDER BY id ASC";
    ...
    return $work;
  	...
  	function teaching() { //query for teaching experience
    global $connection;
    $query  = "SELECT * ";
    $query .= "FROM teaching ";
    $query .= "ORDER BY id ASC";
	...
	function find_blog_by_id($id) { //query for user by id
		global $connection;
	...
	function find_admin_by_id($admin_id) { //query for user by id
		global $connection;
